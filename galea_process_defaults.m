...
opt = struct( ...
    ...
    'asr2',         0, ...           % 2nd ASR pass after ICA, threshold; 0 = skip
    'asr2mode',     'reconstruct', ...
    'plotspectra',  false, ...       % pop_spectopo (1-70 Hz) at the end of EEG cleaning
    'viseeg',       true, ...
    ...
    'plotconds',    {{}}, ...        % ERP: event labels to plot; {} = none ({{}}: struct() needs it)
